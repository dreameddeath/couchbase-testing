 ...
 */
public class GenericDocumentItemValidator implements Validator<Object>{
    ...
    public void validate(Object element,RawCouchbaseDocumentElement parent) throws ValidationException{
