 ...
 */
public class CouchbaseDocumentElementValidator<T extends RawCouchbaseDocumentElement> implements Validator<T>{
    ...
    public CouchbaseDocumentElementValidator(Class<T> rootObj,ValidatorFactory factory){
        ...
        if((rootObj.getSuperclass()!=null) && RawCouchbaseDocumentElement.class.isAssignableFrom(rootObj.getSuperclass())){
            Class<RawCouchbaseDocumentElement> parentClass = (Class<RawCouchbaseDocumentElement>)rootObj.getSuperclass();
            this._validationRules.putAll(((CouchbaseDocumentElementValidator) factory.getValidator(parentClass)).getValidationRules());
        }
    }

    public void validate(T element,RawCouchbaseDocumentElement parent) throws ValidationException{
