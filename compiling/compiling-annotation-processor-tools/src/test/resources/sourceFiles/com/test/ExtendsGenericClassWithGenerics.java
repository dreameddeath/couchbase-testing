...
public abstract class ExtendsGenericClassWithGenerics<TREQ extends String,TRES extends Map<String,String> & Closeable> extends ClassWithGenerics<TREQ,TRES>{
