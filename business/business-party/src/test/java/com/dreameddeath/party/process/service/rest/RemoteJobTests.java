...
import com.dreameddeath.party.process.model.v1.party.published.process.PersonRequest;
import com.dreameddeath.party.process.model.v1.party.published.process.TypeRequest;
import com.dreameddeath.party.process.model.v1.published.process.CreateUpdatePartyJobRequest;
import com.dreameddeath.party.process.model.v1.published.process.CreateUpdatePartyJobResponse;
...
public class RemoteJobTests {
    ...
    public void init() throws Exception{
        ...
        ConfigManagerFactory.addPersistentConfigurationEntry(CouchbaseDaoConfigProperties.COUCHBASE_DAO_BUCKET_NAME.getProperty("core", "crossdomainbridge").getName(), "testBucketName");
