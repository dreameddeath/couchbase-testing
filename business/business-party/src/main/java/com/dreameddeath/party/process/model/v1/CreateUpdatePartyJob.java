...
public class CreateUpdatePartyJob extends AbstractJob {
     ...
     */
    @DocumentProperty("request") @Request(mode= FieldGenMode.UNWRAP,unwrappedDefaultMode = FieldGenMode.SIMPLE)
     ...
     */
    @DocumentProperty("response") @Result(mode= FieldGenMode.UNWRAP,unwrappedDefaultMode = FieldGenMode.SIMPLE)
