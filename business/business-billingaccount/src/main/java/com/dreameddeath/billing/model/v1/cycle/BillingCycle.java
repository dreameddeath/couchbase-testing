...
@QueryExpose(rootPath = "/billing",name = "cycle",superClassGenMode = SuperClassGenMode.UNWRAP)
@DocumentEntity(name="cycle")
@DaoEntity(baseDao= BusinessCouchbaseDocumentWithKeyPatternDao.class,dbPath = "cycle/",idPattern = "\\d{5}",idFormat = "%05d")
