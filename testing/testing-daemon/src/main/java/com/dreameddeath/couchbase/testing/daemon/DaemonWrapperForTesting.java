...
public class DaemonWrapperForTesting {
    ...
    public RestServiceDiscoverer getServiceDiscoveryForDomain(String domain){
        return (RestServiceDiscoverer) getServiceDiscoveryForDomain(domain, RestServiceTypeHelper.SERVICE_TECH_TYPE);
    }
    ...
    public RestServiceClientFactory getServiceFactoryForDomain(String domain){
        return (RestServiceClientFactory)getServiceFactoryForDomain(domain,RestServiceTypeHelper.SERVICE_TECH_TYPE);
    }
}
