...
public class AbstractDaemon {
    ...
    static{
        try {
            ...
            String addressProp = ConfigPropertyFactory.getStringProperty("zookeeper.cluster.addresses", null).getMandatoryValue("The zookeeper cluster address must be defined");
