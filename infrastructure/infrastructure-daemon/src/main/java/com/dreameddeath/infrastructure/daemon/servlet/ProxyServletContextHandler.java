...
public class ProxyServletContextHandler extends AbstractServletContextHandler {
    ...
    public ProxyServletContextHandler(AbstractWebServer parentServer,Collection<String> domainsToSelfDiscover,String serviceTechType,String path){
        super(parentServer);
        ...
        if(serviceTechType!=null){
            this.setAttribute(ProxyServlet.PROXY_SERVICE_TECH_TYPE, serviceTechType);
        }
    }
}
