...
define(['angular','angular-route','angular-animate','apps-admin-daemon-resource','ui-bootstrap-tpls'],function(angular){
    var appsAdminModule = angular.module('apps-admin-daemon',['apps-admin-daemon-resource','ngResource','ngRoute','ui.bootstrap.modal',
