...
public class Address extends BaseCouchbaseDocumentElement {
    ...
    private Property<String> apartmentNumber = new StandardProperty<String>(Address.this);
    /**
     *  buildingName :
     */
    @DocumentProperty("buildingName")
    private Property<String> buildingName = new StandardProperty<String>(Address.this);
    /**
     *  houseType :
     */
    @DocumentProperty("houseType")
    private Property<String> houseType = new StandardProperty<String>(Address.this);
    /**
     *  floorNumber :
     */
    @DocumentProperty("floorNumber")
    private Property<String> floorNumber = new StandardProperty<String>(Address.this);
    /**
     *  staircaseNumber :
     */
    @DocumentProperty("staircaseNumber")
    private Property<String> staircaseNumber = new StandardProperty<String>(Address.this);
    /**
     *  geoCode :
     */
    @DocumentProperty("geoCode")
    private Property<String> geoCode = new StandardProperty<String>(Address.this);
    /**
     *  residenceName :
     */
    @DocumentProperty("residenceName")
    private Property<String> residenceName = new StandardProperty<String>(Address.this);
    /**
     *  roadNumber :
     */
    @DocumentProperty("roadNumber")
    private Property<String> roadNumber = new StandardProperty<String>(Address.this);
    /**
     *  roadLetter :
     */
    @DocumentProperty("roadLetter")
    private Property<String> roadLetter = new StandardProperty<String>(Address.this);
    /**
     *  roadType :
     */
    @DocumentProperty("roadType")
    private Property<String> roadType = new StandardProperty<String>(Address.this);
    /**
     *  roadName :
     */
    @DocumentProperty("roadName")
    private Property<String> roadName = new StandardProperty<String>(Address.this);
    /**
     *  locality :
     */
    @DocumentProperty("locality")
    private Property<String> locality = new StandardProperty<String>(Address.this);
    /**
     *  postalCode : Postal Code of the city
     */
    @DocumentProperty("postalCode")
    private Property<String> postalCode = new StandardProperty<String>(Address.this);
    /**
     *  cityName : Name of the city
     */
    @DocumentProperty("cityName")
    private Property<String> cityName = new StandardProperty<String>(Address.this);
    /**
     *  state :
     */
    @DocumentProperty("state")
    private Property<String> state = new StandardProperty<String>(Address.this);
    /**
     *  countryName :
     */
    @DocumentProperty("countryName")
    private Property<String> countryName = new StandardProperty<String>(Address.this);
