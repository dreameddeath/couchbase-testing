...
public class CreateUpdateInstalledBaseService {
    public CreateUpdateInstalledBaseResponse createUpdateInstalledBase(InstalledBase ref, CreateUpdateInstalledBaseRequest.Contract reqContract ){
        ...
        if(reqContract.comOp.equals(CreateUpdateInstalledBaseRequest.CommercialOperation.ADD)){
            createContract(res,ref,reqContract);
        }

        updateContract(ref.getContract(),reqContract);


        return res;
    }

    public void initItem(InstalledItem targetItem,CreateUpdateInstalledBaseRequest.IdentifiedItem item){
        InstalledStatus newItemDefaultStatus = new InstalledStatus();
        newItemDefaultStatus.setCode(InstalledStatus.Code.INITIALIZED);
        newItemDefaultStatus.setStartDate(targetItem.getParentDocument().getBaseMeta().getSession().getDateTimeService().getCurrentDate());
        targetItem.setStatus(newItemDefaultStatus);


    }

    public InstalledContract createContract(CreateUpdateInstalledBaseResponse res, InstalledBase ref, CreateUpdateInstalledBaseRequest.Contract refContract  ){
        ...
        newContractDefaultStatus.setStartDate(ref.getBaseMeta().getSession().getDateTimeService().getCurrentDate());
    ...
    public void updateContract(InstalledContract contract, CreateUpdateInstalledBaseRequest.Contract reqContract){
        InstalledContractRevision rev = getContractRevision(contract,reqContract);


    }

    public InstalledContractRevision getContractRevision(InstalledContract contract, CreateUpdateInstalledBaseRequest.Contract reqContract){
        for(InstalledContractRevision revision:contract.getRevisions()){
            ...
            {
                updateRevision(revision,reqContract);
                return revision;
            }
        }
    ...
    public void updateRevision(InstalledItemRevision rev, CreateUpdateInstalledBaseRequest.IdentifiedItem item){
    ...
    public InstalledItem findMatchingItem(InstalledBase ref, CreateUpdateInstalledBaseRequest.IdentifiedItem item){
    ...
    public InstalledItemRevision findMatchingRevision(InstalledItem ref, CreateUpdateInstalledBaseRequest.IdentifiedItem item){
        return null;
    }

    public InstalledItemRevision createRevision(InstalledItem ref, CreateUpdateInstalledBaseRequest.IdentifiedItem item){
        return null;
    }
