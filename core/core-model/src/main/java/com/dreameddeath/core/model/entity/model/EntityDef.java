...
public class EntityDef {
    ...
    public static <T extends CouchbaseDocument> EntityDef build(Class<T> clazz){
        return build(CouchbaseDocumentStructureReflection.getReflectionFromClass((Class)clazz));
    }
