...
public class ElasticSearchSearchQueryBuilder extends SearchRequestBuilder {
    ...
    public Single<SearchResponse> executeAsync() {
        return ElasticSearchClient.fromListenableFuture(super.execute()); //Todo manage errors and potentially source mapping
    }
