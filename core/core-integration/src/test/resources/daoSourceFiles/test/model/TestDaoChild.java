...
@DocumentEntity(domain="testGeneration",name="daoProccessorChild",version = "1.0.0")
@DaoEntity(baseDao = BusinessCouchbaseDocumentWithKeyPatternDao.class,dbPath = "child/",idFormat = "%010d",idPattern = "\\d{10}")
