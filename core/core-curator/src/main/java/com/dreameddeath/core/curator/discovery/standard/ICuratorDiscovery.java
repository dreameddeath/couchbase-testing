 ...
 */
public interface ICuratorDiscovery<T extends IRegisterable> extends IGenericCuratorDiscovery<T,ICuratorDiscoveryListener<T>,ICuratorDiscoveryLifeCycleListener> {
