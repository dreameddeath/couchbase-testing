...
public class SoapCuratorDiscoveryServiceDescription extends CuratorDiscoveryServiceDescription<String> {
    ...
    public String getServiceTechType() {
        return SoapServiceTypeHelper.SERVICE_TECH_TYPE;
    }

    @Override
    public void setServiceTechType(String serviceType) {
        Preconditions.checkArgument(SoapServiceTypeHelper.SERVICE_TECH_TYPE.equals(SoapServiceTypeHelper.SERVICE_TECH_TYPE),"Wrong service type %s",serviceType);
    }
