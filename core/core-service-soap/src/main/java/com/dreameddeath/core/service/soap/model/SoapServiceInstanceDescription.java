 ...
 */
public class SoapServiceInstanceDescription extends ServiceInstanceDescription {
    public SoapServiceInstanceDescription(ServiceInstance<SoapCuratorDiscoveryServiceDescription> instance) {
        super(instance);
    }

    //For jackson
    public SoapServiceInstanceDescription(){}
