...
import com.dreameddeath.core.dao.annotation.DaoGeneratorPluginTestImpl;
...
@DocumentEntity(domain="testDaoGenerationInlined",name="daoProccessorChild",version = "1.0.0")
@DaoEntity(baseDao = CouchbaseDocumentWithKeyPatternDao.class,
        dbPath = "child/",
        idFormat = "%010d",
        idPattern = "\\d{10}",
        plugins = {
                DaoGeneratorPluginTestImpl.class
        })
