...
@DocumentEntity(domain="testDaoGenerationInlined",name="daoProccessor",version = "1.0.0")
@DaoEntity(baseDao = CouchbaseDocumentWithKeyPatternDao.class,dbPath = "test/",idFormat = "%010d",idPattern = "\\d{10}")
...
@View(name = "valueView",
        ...
        keyDef = @ViewKeyDef(type=String.class,transcoder = ViewStringKeyTranscoder.class),
        valueDef = @ViewValueDef(type=String.class,transcoder = ViewStringTranscoder.class))
public class TestGeneratedDao extends CouchbaseDocument implements ITestDao {
