...
public class ViewDef {
    ...
    public ViewDef(Filer filer, EntityDef entity, CouchbaseDocumentReflection documentReflection, View viewAnnot) {
        name = viewAnnot.name();
        ...
        if (StringUtils.isNotEmpty(viewAnnot.content())) {
            ...
            try(InputStream inputStream = filer.getResource(StandardLocation.CLASS_PATH,"",contentFilename).openInputStream()){
                if (inputStream == null) {
