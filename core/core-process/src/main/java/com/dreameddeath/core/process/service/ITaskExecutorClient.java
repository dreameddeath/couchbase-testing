...
public interface ITaskExecutorClient<TJOB extends AbstractJob,TTASK extends AbstractTask> {
    ...
    Single<TaskContext<TJOB,TTASK>> executeTask(JobContext<TJOB> parentContext, TTASK task) throws TaskExecutionException;
    Single<TaskContext<TJOB,TTASK>> executeTask(TJOB parentJob,TTASK task, IUser user) throws TaskExecutionException;
