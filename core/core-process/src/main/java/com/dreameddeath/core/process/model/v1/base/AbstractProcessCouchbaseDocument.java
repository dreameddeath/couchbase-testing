 ...
 */
@QueryExpose(rootPath = "dummy", notDirecltyExposed = true,defaultOutputFieldMode = FieldGenMode.FILTER,superClassGenMode = SuperClassGenMode.UNWRAP)
public abstract class AbstractProcessCouchbaseDocument extends CouchbaseDocument implements IDocumentWithLinkedTasks {
    ...
    @DocumentProperty("attachedTasks") @QueryFieldInfo
