...
import com.dreameddeath.core.dao.service.annotation.processor.DaoServiceGeneratorAnnotationProcessor;
 ...
 */
public class DaoServiceGenerationTest extends Assert {
    ...
    public void initTest() throws  Exception{
        ...
        annotTester.
                ...
                withAnnotationProcessor(new DaoServiceGeneratorAnnotationProcessor()).
    ...
    public void runAnnotationProcessor() throws Exception {
        ...
        RxJavaWebTarget readTarget = server.getClientFactory().getClient(DaoHelperServiceUtils.SERVICE_TYPE_DATA,"daoProccessor$read", "1.0.0")
                .getInstance()
                .register(JsonProviderFactory.getProvider(CouchbaseDocumentObjectMapperConfigurator.BASE_COUCHBASE_PUBLIC));

        RxJavaWebTarget writeTarget = server.getClientFactory().getClient(DaoHelperServiceUtils.SERVICE_TYPE_DATA,"daoProccessor$write", "1.0.0")
                .getInstance()
                .register(JsonProviderFactory.getProvider(CouchbaseDocumentObjectMapperConfigurator.BASE_COUCHBASE_PUBLIC));

        RxJavaWebTarget childReadTarget = server.getClientFactory().getClient(DaoHelperServiceUtils.SERVICE_TYPE_DATA,"daoProccessorChild$read", "1.0.0")
                .getInstance()
                .register(JsonProviderFactory.getProvider(CouchbaseDocumentObjectMapperConfigurator.BASE_COUCHBASE_PUBLIC));
        RxJavaWebTarget childWriteTarget = server.getClientFactory().getClient(DaoHelperServiceUtils.SERVICE_TYPE_DATA,"daoProccessorChild$write", "1.0.0")
                .getInstance()
                .register(JsonProviderFactory.getProvider(CouchbaseDocumentObjectMapperConfigurator.BASE_COUCHBASE_PUBLIC));
