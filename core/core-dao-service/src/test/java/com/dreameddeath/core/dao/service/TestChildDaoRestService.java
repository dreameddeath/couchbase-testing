...
@ServiceDef(domain="testDao",type= DaoHelperServiceUtils.SERVICE_TYPE_DATA,name="testChild",version="1.0",status = VersionStatus.STABLE,access = DataAccessType.READ_WRITE)
