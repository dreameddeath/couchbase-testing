...
public class ProcessPublishEventDtoModelGeneratorPlugin extends AbstractStandardPureOutputGeneratorPluginImpl<PublishEvent,PublishEventField> {
    ...
    @Override
    public void addFieldInfo(String name, FieldSpec.Builder fieldBuilder, ParameterizedTypeInfo effectiveTypeInfo, FieldInfo fieldInfo, Key key, List<AbstractDtoModelGenerator.UnwrappingStackElement> unwrappingStackElements) {

    }

    @Override
    public void addSetterInfo(String name, MethodSpec.Builder setterBuilder, ParameterizedTypeInfo effectiveTypeInfo, FieldInfo fieldInfo, Key key, List<AbstractDtoModelGenerator.UnwrappingStackElement> unwrappingStackElements) {

    }

    @Override
    public void addGetterInfo(String name, MethodSpec.Builder setterBuilder, ParameterizedTypeInfo effectiveTypeInfo, FieldInfo fieldInfo, Key key, List<AbstractDtoModelGenerator.UnwrappingStackElement> unwrappingStackElements) {
