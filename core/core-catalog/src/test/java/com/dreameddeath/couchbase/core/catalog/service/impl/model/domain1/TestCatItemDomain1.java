package com.dreameddeath.couchbase.core.catalog.service.impl.model.domain1;
...
@DaoEntity(baseDao = CouchbaseDocumentWithKeyPatternDao.class,dbPath = "cat/item1/",idFormat = "%010d",idPattern = "\\d{10}")
@Counter(name = "cnt",dbName = "cnt",isKeyGen = true)
@DocumentEntity
public class TestCatItemDomain1 extends CatalogElement {
    @DocumentProperty
