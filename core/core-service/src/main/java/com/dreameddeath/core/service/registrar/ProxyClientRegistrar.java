 ...
 */
public class ProxyClientRegistrar extends CuratorRegistrarImpl<ProxyClientInstanceInfo>{
    ...
    public void enrich(ProxyClientInstanceInfo obj){
        obj.setDaemonUid(daemonUid);
        obj.setWebServerUid(webServerUid);
    }

    @Override
    protected byte[] serialize(ProxyClientInstanceInfo obj) throws Exception {
