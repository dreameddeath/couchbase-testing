 ...
 */
public class RestServiceDiscoverer extends AbstractServiceDiscoverer<Swagger,RestCuratorDiscoveryServiceDescription> {

    public RestServiceDiscoverer(CuratorFramework client, String domain) {
        super(client, domain, RestServiceTypeHelper.SERVICE_TECH_TYPE);
    }
